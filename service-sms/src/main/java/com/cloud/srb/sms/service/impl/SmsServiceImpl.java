package com.cloud.srb.sms.service.impl;
...
public class SmsServiceImpl implements SmsService {
    ...
    public void send(String mobile, String templateCode, Map<String, Object> param) {
        ...
        Gson gson = new Gson();
        String jsParam = gson.toJson(param);
        request.putQueryParameter("TemplateParam", jsParam);
        try {
            //使用客户端对象携带请求参数像远程阿里云服务器发起远程调用，并得到响应结果
